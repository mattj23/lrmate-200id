...
static struct PyModuleDef pyikfast_lrmate200idmodule = {
    PyModuleDef_HEAD_INIT,
    "pyikfast_lrmate200id",
    "ikfast wrapper",
    -1,
    PyIkFastMethods};

PyMODINIT_FUNC PyInit_pyikfast_lrmate200id(void)
{
  PyObject *module = PyModule_Create(&pyikfast_lrmate200idmodule);
  return module;
}
