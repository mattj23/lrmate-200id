...
///
/// ikfast version 0x1000004a generated on 2023-03-22 21:39:24.788142
...
x38=(x35*x7);
x39=(x33*x7);
x40=(((x34*x8))+(((-1.0)*x15*x7)));
x41=(((x0*x7))+x37);
x42=(((x32*x5*x8))+((x6*(((((-1.0)*x1*x20))+(((-1.0)*x17*x4)))))));
x43=(((x6*(((((-1.0)*x0*x1*x17))+x30))))+((x40*x5)));
x44=(((x6*(((((-1.0)*x15*x22))+x31))))+((x41*x5)));
eerot[0]=(((x5*(((((-1.0)*x30))+((x0*x22))))))+((x40*x6)));
eerot[1]=(((x10*(((((-1.0)*x28))+x39))))+((x11*x43)));
eerot[2]=(((x11*(((((-1.0)*x39))+x28))))+((x10*x43)));
IkReal x45=((1.0)*x24);
eetrans[0]=(((x6*((((x16*x34))+(((-1.0)*x14*x7))))))+(((-1.0)*x18*x45))+x13+(((0.333401)*x0*x22))+(((-0.33)*x24))+(((-0.035027)*x0*x25))+(((-1.0)*x12*x45))+((x5*(((((-1.0)*x13*x27))+((x13*x22)))))));
eerot[3]=(((x5*(((((-1.0)*x31))+((x22*x9))))))+((x41*x6)));
eerot[4]=(((x11*x44))+((x10*((((x0*x8))+x38)))));
eerot[5]=(((x10*x44))+((x11*(((((-1.0)*x38))+(((-1.0)*x19*x8)))))));
IkReal x46=((1.0)*x21);
eetrans[1]=((((-0.035027)*x25*x9))+(((-1.0)*x18*x46))+x14+(((0.333401)*x22*x9))+(((-0.33)*x21))+((x5*((((x14*x22))+(((-1.0)*x14*x27))))))+(((-1.0)*x12*x46))+((x6*((((x16*x36))+((x13*x7)))))));
eerot[6]=(((x23*x32))+((x5*((x25+x26)))));
eerot[7]=(((x11*x42))+((x10*x7*(((((-1.0)*x1*x17))+x29)))));
eerot[8]=(((x10*x42))+((x11*x32*x7)));
eetrans[2]=((0.330001)+((x23*(((((-0.05)*x27))+(((0.05)*x22))))))+(((-0.035027)*x27))+((x1*x12))+((x1*x18))+((x5*(((((0.05)*x25))+(((0.05)*x26))))))+(((0.33)*x1))+(((0.333401)*x26)));
}
...
_nj2 = 2;
if( (((0.988824761658883)+(((0.451965751664222)*cj0*px))+(((0.451965751664222)*py*sj0))+(((-4.51965751664222)*pp)))) < -1-IKFAST_SINCOS_THRESH || (((0.988824761658883)+(((0.451965751664222)*cj0*px))+(((0.451965751664222)*py*sj0))+(((-4.51965751664222)*pp)))) > 1+IKFAST_SINCOS_THRESH )
    continue;
IkReal x52=IKasin(((0.988824761658883)+(((0.451965751664222)*cj0*px))+(((0.451965751664222)*py*sj0))+(((-4.51965751664222)*pp))));
j2array[0]=((-0.104675679433686)+(((-1.0)*x52)));
sj2array[0]=IKsin(j2array[0]);
cj2array[0]=IKcos(j2array[0]);
j2array[1]=((3.03691697415611)+x52);
...
IkReal x54=(py*sj0);
IkReal x55=(cj0*px);
IkReal x56=((0.333401)*cj2);
IkReal x57=((0.035027)*sj2);
IkReal x58=(pz*sj2);
IkReal x59=(cj2*pz);
IkReal x60=((190.368001827162)*cj2);
j1eval[0]=((((-1.0)*sj2))+(((9.5184000913581)*cj2))+(((190.368001827162)*x58))+(((-1.0)*x55*x60))+(((20.0)*x59))+(((-1.0)*x54*x60))+((x53*x55))+((x53*x54))+(((188.426071316413)*pz)));
j1eval[1]=IKsign(((((0.01667005)*cj2))+(((-0.00175135)*sj2))+(((0.333401)*x58))+(((-1.0)*x55*x56))+(((0.33)*pz))+(((-1.0)*x54*x56))+(((0.035027)*x59))+((x55*x57))+((x54*x57))));
...
IkReal x64=(cj0*px);
IkReal x65=((20.0)*cj2);
IkReal x66=((0.333401)*sj2);
IkReal x67=(cj2*pz);
IkReal x68=((0.035027)*cj2);
IkReal x69=((190.368001827162)*sj2);
IkReal x70=(cj2*sj2);
j1eval[0]=((-9.42130356582065)+(((190.368001827162)*x67))+(((188.426071316413)*x62))+(((188.426071316413)*x64))+((x62*x65))+((x62*x69))+(((-20.0)*x63))+((x64*x65))+((x64*x69))+(((-9.5184000913581)*sj2))+(((-1.0)*cj2)));
j1eval[1]=IKsign(((-0.0165)+(((0.333401)*x67))+((x62*x66))+((x62*x68))+(((0.33)*x62))+(((0.33)*x64))+(((-0.00175135)*cj2))+(((-0.035027)*x63))+((x64*x66))+((x64*x68))+(((-0.01667005)*sj2))));
j1eval[2]=((IKabs(((-0.011678036827)+(((-0.05)*pz))+(((0.109929336072)*x70))+(((0.11002233)*cj2))+((pz*x64))+((pz*x62))+(((-0.01155891)*sj2))+(((0.023356073654)*x61)))))+(IKabs(((-0.220056226801)+(((-0.023356073654)*x70))+(((-0.22004466)*sj2))+(pz*pz)+(((-0.02311782)*cj2))+(((0.109929336072)*x61))))));
...
IkReal x77=(x71*x72);
IkReal x78=(x72*x73);
j1eval[0]=((-1.0)+(((40.0)*x76))+(((40.0)*x75))+(((400.0)*x77))+(((-800.0)*x75*x76))+(((-400.0)*x71))+(((-400.0)*x74))+(((-400.0)*x78)));
j1eval[1]=IKsign(((-0.0025)+(((0.1)*x76))+(((0.1)*x75))+(((-2.0)*x75*x76))+x77+(((-1.0)*x78))+(((-1.0)*x74))+(((-1.0)*x71))));
if( IKabs(j1eval[0]) < 0.0000010000000000  || IKabs(j1eval[1]) < 0.0000010000000000  )
{
...
IkReal x81=(py*sj0);
IkReal x82=(cj0*px);
IkReal x83=((0.333401)*sj2);
IkReal x84=(cj2*pz);
IkReal x85=((0.333401)*cj2);
IkReal x86=((0.035027)*cj2);
IkReal x87=((0.035027)*sj2);
CheckValue<IkReal> x88=IKPowWithIntegerCheck(IKsign(((-0.0025)+((x79*x80))+(((-1.0)*x80*(px*px)))+(((0.1)*x82))+(((0.1)*x81))+(((-2.0)*x81*x82))+(((-1.0)*(pz*pz)))+(((-1.0)*x79)))),-1);
if(!x88.valid){
continue;
}
CheckValue<IkReal> x89 = IKatan2WithCheck(IkReal(((-0.0165)+(((-0.333401)*x84))+((x82*x86))+((x82*x83))+((x81*x86))+((x81*x83))+((pz*x87))+(((0.33)*x82))+(((0.33)*x81))+(((-0.00175135)*cj2))+(((-0.01667005)*sj2)))),IkReal(((((-1.0)*x81*x85))+(((0.01667005)*cj2))+(((-1.0)*x82*x85))+((x82*x87))+((x81*x87))+(((-0.00175135)*sj2))+(((-0.33)*pz))+(((-0.035027)*x84))+(((-1.0)*pz*x83)))),IKFAST_ATAN2_MAGTHRESH);
if(!x89.valid){
continue;
}
...
IkReal x92=(py*sj0);
IkReal x93=(cj0*px);
IkReal x94=((0.035027)*sj2);
IkReal x95=((1.0)*pz);
IkReal x96=((0.333401)*cj2);
IkReal x97=((0.035027)*cj2);
IkReal x98=((0.333401)*sj2);
IkReal x99=((0.66)*x90);
IkReal x100=((1.0)*x91);
evalcond[0]=((0.33)+(((-1.0)*x91*x95))+(((-0.05)*x90))+((x90*x93))+((x90*x92))+x98+x97);
evalcond[1]=((((0.05)*x91))+(((-1.0)*x90*x95))+x96+(((-1.0)*x94))+(((-1.0)*x100*x92))+(((-1.0)*x100*x93)));
evalcond[2]=((((-1.0)*x90*x94))+(((0.33)*x91))+((x90*x96))+(((-1.0)*x95))+((x91*x98))+((x91*x97)));
evalcond[3]=((0.00098311753)+(((0.1)*x93))+(((0.1)*x92))+(((-1.0)*pp))+(((0.66)*pz*x91))+(((-1.0)*x92*x99))+(((0.033)*x90))+(((-1.0)*x93*x99)));
evalcond[4]=((0.05)+(((-1.0)*x90*x97))+(((-1.0)*x90*x98))+(((-1.0)*x91*x94))+(((-0.33)*x90))+(((-1.0)*x92))+(((-1.0)*x93))+((x91*x96)));
...
IkReal x1521=(py*sj0);
IkReal x1522=(cj0*px);
IkReal x1523=((0.333401)*sj2);
IkReal x1524=((0.035027)*cj2);
IkReal x1525=(cj2*sj2);
CheckValue<IkReal> x1526 = IKatan2WithCheck(IkReal(((-0.220056226801)+(((-0.22004466)*sj2))+(pz*pz)+(((-0.023356073654)*x1525))+(((-0.02311782)*cj2))+(((0.109929336072)*x1520)))),IkReal(((-0.011678036827)+(((0.023356073654)*x1520))+(((-0.05)*pz))+(((0.11002233)*cj2))+((pz*x1522))+((pz*x1521))+(((0.109929336072)*x1525))+(((-0.01155891)*sj2)))),IKFAST_ATAN2_MAGTHRESH);
if(!x1526.valid){
continue;
}
CheckValue<IkReal> x1527=IKPowWithIntegerCheck(IKsign(((-0.0165)+(((0.33)*x1521))+(((0.33)*x1522))+((x1522*x1524))+((x1522*x1523))+(((-0.035027)*pz*sj2))+((x1521*x1524))+((x1521*x1523))+(((-0.00175135)*cj2))+(((0.333401)*cj2*pz))+(((-0.01667005)*sj2)))),-1);
if(!x1527.valid){
continue;
}
...
IkReal x1530=(py*sj0);
IkReal x1531=(cj0*px);
IkReal x1532=((0.035027)*sj2);
IkReal x1533=((1.0)*pz);
IkReal x1534=((0.333401)*cj2);
IkReal x1535=((0.035027)*cj2);
IkReal x1536=((0.333401)*sj2);
IkReal x1537=((0.66)*x1528);
IkReal x1538=((1.0)*x1529);
evalcond[0]=((0.33)+(((-1.0)*x1529*x1533))+((x1528*x1530))+((x1528*x1531))+(((-0.05)*x1528))+x1536+x1535);
evalcond[1]=((((0.05)*x1529))+(((-1.0)*x1530*x1538))+(((-1.0)*x1531*x1538))+(((-1.0)*x1532))+x1534+(((-1.0)*x1528*x1533)));
evalcond[2]=((((0.33)*x1529))+((x1528*x1534))+(((-1.0)*x1533))+((x1529*x1535))+((x1529*x1536))+(((-1.0)*x1528*x1532)));
evalcond[3]=((0.00098311753)+(((0.033)*x1528))+(((-1.0)*x1530*x1537))+(((-1.0)*x1531*x1537))+(((-1.0)*pp))+(((0.1)*x1531))+(((0.1)*x1530))+(((0.66)*pz*x1529)));
evalcond[4]=((0.05)+(((-1.0)*x1529*x1532))+(((-1.0)*x1531))+(((-1.0)*x1530))+(((-0.33)*x1528))+((x1529*x1534))+(((-1.0)*x1528*x1536))+(((-1.0)*x1528*x1535)));
if( IKabs(evalcond[0]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[1]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[2]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[3]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[4]) > IKFAST_EVALCOND_THRESH  )
{
continue;
}
...
IkReal x1540=(py*sj0);
IkReal x1541=((0.333401)*cj2);
IkReal x1542=(cj2*sj2);
IkReal x1543=(cj0*px);
IkReal x1544=((1.0)*pz);
IkReal x1545=((0.035027)*sj2);
CheckValue<IkReal> x1546=IKPowWithIntegerCheck(IKsign(((((0.01667005)*cj2))+(((-1.0)*x1540*x1541))+(((-0.00175135)*sj2))+(((0.035027)*cj2*pz))+(((0.33)*pz))+(((0.333401)*pz*sj2))+((x1540*x1545))+((x1543*x1545))+(((-1.0)*x1541*x1543)))),-1);
if(!x1546.valid){
continue;
}
CheckValue<IkReal> x1547 = IKatan2WithCheck(IkReal(((-0.011678036827)+(((-1.0)*x1543*x1544))+(((-1.0)*x1540*x1544))+(((0.023356073654)*x1539))+(((0.109929336072)*x1542))+(((0.11002233)*cj2))+(((-0.01155891)*sj2))+(((0.05)*pz)))),IkReal(((-0.001226890729)+(((0.023356073654)*x1542))+(pz*pz)+(((-0.109929336072)*x1539)))),IKFAST_ATAN2_MAGTHRESH);
if(!x1547.valid){
continue;
}
j1array[0]=((-1.5707963267949)+(((1.5707963267949)*(x1546.value)))+(x1547.value));
sj1array[0]=IKsin(j1array[0]);
cj1array[0]=IKcos(j1array[0]);
if( j1array[0] > IKPI )
{
...
IkReal x1550=(py*sj0);
IkReal x1551=(cj0*px);
IkReal x1552=((0.035027)*sj2);
IkReal x1553=((1.0)*pz);
IkReal x1554=((0.333401)*cj2);
IkReal x1555=((0.035027)*cj2);
IkReal x1556=((0.333401)*sj2);
IkReal x1557=((0.66)*x1548);
IkReal x1558=((1.0)*x1549);
evalcond[0]=((0.33)+(((-0.05)*x1548))+(((-1.0)*x1549*x1553))+x1555+x1556+((x1548*x1551))+((x1548*x1550)));
evalcond[1]=((((0.05)*x1549))+(((-1.0)*x1548*x1553))+x1554+(((-1.0)*x1550*x1558))+(((-1.0)*x1552))+(((-1.0)*x1551*x1558)));
evalcond[2]=((((0.33)*x1549))+(((-1.0)*x1548*x1552))+((x1549*x1556))+((x1549*x1555))+((x1548*x1554))+(((-1.0)*x1553)));
evalcond[3]=((0.00098311753)+(((0.1)*x1550))+(((0.1)*x1551))+(((-1.0)*pp))+(((-1.0)*x1550*x1557))+(((0.033)*x1548))+(((-1.0)*x1551*x1557))+(((0.66)*pz*x1549)));
evalcond[4]=((0.05)+(((-1.0)*x1550))+(((-1.0)*x1551))+(((-1.0)*x1549*x1552))+(((-0.33)*x1548))+(((-1.0)*x1548*x1555))+(((-1.0)*x1548*x1556))+((x1549*x1554)));
if( IKabs(evalcond[0]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[1]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[2]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[3]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[4]) > IKFAST_EVALCOND_THRESH  )
{
continue;
}
...
IkReal x108=(cj0*r01);
IkReal x109=(r12*sj0);
IkReal x110=(((cj1*cj2))+(((-1.0)*x103)));
IkReal x111=((((-1.0)*cj1*x106))+x103);
IkReal x112=(sj0*x111);
IkReal x113=((((-1.0)*cj1*sj2))+(((-1.0)*sj1*x106)));
IkReal x114=(cj0*x113);
new_r00=(((r20*x110))+((x104*x113))+((x105*x113)));
new_r01=(((r21*x110))+((x108*x113))+((x101*x113)));
new_r02=(((r22*x110))+((x102*x113))+((x109*x113)));
new_r10=((((-1.0)*r00*x107))+((cj0*r10)));
new_r11=((((-1.0)*r01*x107))+((cj0*r11)));
new_r12=((((-1.0)*r02*x107))+((cj0*r12)));
new_r20=(((r20*x113))+((x104*x111))+((x105*x111)));
new_r21=(((r21*x113))+((x108*x111))+((x101*x111)));
new_r22=(((r22*x113))+((x102*x111))+((x109*x111)));
{
...
IKFAST_API const char* GetKinematicsHash() { return "97db232251f497eb5e37081d50054a64"; }
